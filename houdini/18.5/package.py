...
def commands():
    ...
    if os.name == "nt":
        hou_install_path = "C:/Program Files/Side Effects Software/Houdini {}".format(str(this.version))
    ...
    env.PATH.prepend(os.path.join(hfs, os.path.normpath("/python27/Scripts")))
    ...
    env.PYTHONPATH.prepend(os.path.join(hfs, os.path.normpath("python27/lib/site-packages-ui-forced/PySide2")))
